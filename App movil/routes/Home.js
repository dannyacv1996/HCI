  ...
  render() {
    ...
    return (
    	<View>
		    ...
		    <TouchableOpacity onPress={() => navigate('Medicamentos', {name: 'medicamentos'})} style={styles.buttonPress2}>
		    	<Text style={styles.textButton}>Pedir Medicamentos</Text>
		    	<Image style={styles.img2} source={require('../images/btn2.jpg')}/>
		    </TouchableOpacity>

		    <TouchableOpacity onPress={() => navigate('Perfil', {name: 'perfil'})} style={styles.buttonPress3}>
